...
public class HeartDiseaseCompleteData implements Serializable {
    ...
    public HeartDiseaseCompleteData(
            double age, double sex, double cp, double trestbps, double chol, double fbs, double restecg,
            double thalach, double exang, double oldpeak, double slope, double ca, double thal, int num
    ){
        this.age = age; this.sex = sex; this.cp = cp; this.trestbps = trestbps;
        this.chol = chol; this.fbs = fbs; this.restecg = restecg; this.thalach = thalach;
        this.exang = exang; this.oldpeak = oldpeak; this.slope = slope; this.ca = ca;
        this.thal = thal; this.num = num;
    }

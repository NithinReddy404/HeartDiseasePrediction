...
public class HeartDiseasePrediction {
    ...
    public static void main(String[] args) {
        // Startup is handled by App.java + ModelCache.
        // All heavy computation (bestK loops, SA, feature selection) has been
        // moved to ModelCache with hardcoded constants — do not re-add here.
        // System.out.println("Use App.java to start the Spring Boot server.");
    }
